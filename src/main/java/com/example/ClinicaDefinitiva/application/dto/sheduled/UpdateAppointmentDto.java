...
public class UpdateAppointmentDto {
    ...
    private final ScheduleQueryService schedule;


    public UpdateAppointmentDto(ScheduleQueryService schedule, String providedServiceId, String patientId, LocalDateTime newStart, LocalDateTime newEnd, String dentistId, String appointmentId) {
    ...
    public ScheduleQueryService getSchedule() {
        return schedule;
    }
}
