...
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.dto.rol.CloneRoleRequest;
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.dto.rol.PermissionCheckResponse;
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.dto.rol.PermissionRequest;
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.dto.rol.ReasonRequest;
...
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.mapper.rol.RolReadRestMapper;
import com.example.ClinicaDefinitiva.infrastructure.rest.administration.authorization.mapper.rol.RolWriteRestMapper;
...
public class RolController {
    ...
    private final RolReadRestMapper rolReadMapper;
    private final RolWriteRestMapper rolWriteMapper;

    public RolController(RolUseCase rolUseCase, RolReadRestMapper rolReadMapper, RolWriteRestMapper rolWriteMapper) {
...
public RolReadResponse cloneRole(
    ...
    return rolReadMapper.toResponse(
        rolUseCase.cloneRole(RolId.of(id), request.description(), userIdentityId, rolId)
    );
}
