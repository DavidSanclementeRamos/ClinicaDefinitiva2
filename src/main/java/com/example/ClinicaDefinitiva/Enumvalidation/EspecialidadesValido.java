...
import com.example.ClinicaDefinitiva.Enumvalidation.impl.EspecialidadesValidator;
...
@Constraint(validatedBy = EspecialidadesValidator.class)//Está marcando que esta anotación será utilizada como una restricción de validación, indica que clase se encarga de la logica
public @interface EspecialidadesValido {
    String message() default "Especialidad no válido"; // mensaje de error puede sobre escribirse: @RolValido(message = "Este rol no está permitido")
    ...
    Especialidades[] allowed() default {Especialidades.CIRUGIA_ORAL,Especialidades.ENDODONCIA,
            Especialidades.ORTODONCIA,Especialidades.PERIODONCIA };
}
