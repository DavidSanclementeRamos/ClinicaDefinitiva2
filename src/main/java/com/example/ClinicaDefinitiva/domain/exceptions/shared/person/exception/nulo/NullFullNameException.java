...
public class NullFullNameException extends NullValueException {
    public NullFullNameException(ContextoEntidad contexto, String detalle) {
        super(ErrorCatalog.NULL_FULL_NAME, contexto, detalle);
    }
}
