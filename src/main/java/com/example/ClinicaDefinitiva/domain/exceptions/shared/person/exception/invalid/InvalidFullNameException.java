...
public class InvalidFullNameException extends InvalidFormatException {
    public InvalidFullNameException(ErrorCatalog catalogo, ContextoEntidad contexto, String detalle) {
