...
ERR_SERVICE_INVALID_MIN_AGE(
        "RN-SERVICE-020",
        "error.service.invalid.minAge",
        "La edad mínima del servicio es inválida"
),

ERR_SERVICE_INVALID_RANGE(
        "RN-SERVICE-021",
        "error.service.invalid.range",
        "El rango definido para el servicio es inválido"
);
