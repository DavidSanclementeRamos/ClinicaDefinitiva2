...
/**
 * Representa una cuenta del plan contable (PUC - Plan Único de Cuentas).
 * Esta clase es vital ya que el plan de cuentas se persiste mediante JSON.
 * Define la estructura contable y las reglas para el registro de transacciones.
 */
public final class LedgerAccount {
    ...
    /**
     * Factory method para registrar una nueva cuenta contable.
     */
    ...
    /**
     * Obtiene el nivel de la cuenta en la jerarquía del plan contable.
