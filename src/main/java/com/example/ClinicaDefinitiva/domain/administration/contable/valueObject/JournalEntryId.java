...
/**
 * Value Object que representa el ID de un registro contable.
 * Inmutable y con validaciones de negocio.
 */
public class JournalEntryId {
    // si son registros contables journal entries, si son operaciones transactions, movimiento contable
