package com.example.ClinicaDefinitiva.domain.identity.model;
...
public class UserModel {
    ...
    public UserModel(boolean accountNoExpired, boolean accountNoLocked, boolean credentialNoExpired, LocalDate dateCreate, String gmail, long id, String imagenPerfil, boolean isEnabled, String name, String passwork, Set<Rol> rol, UserStatus statusUser, LocalDate ultimaFechaDeCoexion, UserStatus status) {
