...
package com.example.ClinicaDefinitiva.domain.schudele.model;
...
class AppointmentTest {
    ...
    class CompletionTests {
        ...
        void complete_valid() {
            ...
            appt.complete(completion, new DentistId(10L));
        ...
        void complete_missingCompletion_throws() {
            ...
            assertThatThrownBy(() -> appt.complete(null, new DentistId(10L)))
                    .isInstanceOf(BusinessRuleViolationException.class)
                    .satisfies(ex -> assertThat(((BusinessRuleViolationException) ex).getCatalogo())
