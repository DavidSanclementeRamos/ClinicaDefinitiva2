...
private PagePatientDto createPagePatientDto() {
    ...
    void findAll_shouldReturnPage() {
        ...
        PagePatientDto dto = new PagePatientDto(1L, 1L,3L, "12345678", "Juan", "Pérez", "3001234567");
    ...
    void findByGuardianId_shouldReturnPage() {
        ...
        Patient patient = createPatient();
        Page<Patient> page = new PageImpl<>(List.of(patient));
        PagePatientDto dto = new PagePatientDto(1L, 1L,4L, "12345678", "Juan", "Pérez", "3001234567");
