...
- **Estado**: Aprobado
- **Categoría**: Dominio
- **Depreca**: [ADR-(User)-01-Desactivación de usuarios.md](../../../../evolution/lessons-learned/ADR-%28User%29-01-Desactivaci%C3%B3n%20de%20usuarios.md)
- **Motivado por**: [ADR-(User)-02-UserIdentity como agregado rico.md](ADR-%28User%29-02-UserIdentity%20como%20agregado%20rico.md)
