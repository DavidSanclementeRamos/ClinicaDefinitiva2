# ADR-01: Implementación estratégica de Value Objects (VO) para encapsular lógica semántica y validar reglas clínicas
...
Con la migración hacia arquitectura hexagonal [ADR-(Arquitectura)-01-Migración progresiva a arquitectura hexagonal](../arch/ADR-%28Arquitectura%29-01-Migraci%C3%B3n%20progresiva%20a%20arquitectura%20hexagonal.md), se decidió formalizar el uso de VO como parte esencial del modelo clínico, permitiendo encapsular lógica sensible, validar reglas por operación y evitar degeneración semántica.
