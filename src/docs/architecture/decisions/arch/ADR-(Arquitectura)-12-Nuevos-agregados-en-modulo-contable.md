# ADR-12 (Arquitectura): Nuevos agregados en el módulo administration/accounting
...
## Contexto
Durante la redefinición del módulo administration/accounting, se identificó la necesidad de ampliar el alcance hacia funcionalidades administrativas y contables típicas de sistemas de gestión empresarial.  
...
- [ADR-(Arquitectura)-11-Implementación-inicial-de-módulo-contable.md](ADR-%28Arquitectura%29-11-Implementaci%C3%B3n-inicial-de-m%C3%B3dulo-contable.md)
- [ADR-(Arquitectura)-17-Manejo de Plan de Cuentas y Asientos Contables.md](ADR-%28Arquitectura%29-17-Manejo%20de%20Plan%20de%20Cuentas%20y%20Asientos%20Contables.md)  
