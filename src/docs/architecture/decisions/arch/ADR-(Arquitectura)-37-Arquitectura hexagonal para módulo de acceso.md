...
- **Complementado por:**
    - [ADR-(User)-02-UserIdentity como agregado rico.md](../domain/authentication/ADR-%28User%29-02-UserIdentity%20como%20agregado%20rico.md) 
    - [ADR-(User)-03-Integración Spring Security con dominio.md](../domain/authentication/ADR-%28User%29-03-Integraci%C3%B3n%20Spring%20Security%20con%20dominio.md)
    - [ADR-(User)-04-Validación de usuarios con UserAccessValidator.md](../domain/authentication/ADR-%28User%29-04-Validaci%C3%B3n%20de%20usuarios%20con%20UserAccessValidator.md)
- **Motiva:**
