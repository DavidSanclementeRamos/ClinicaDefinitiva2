Perfecto 🙌, tomando la plantilla que compartiste, aquí te redacto el **ADR formal para la reubicación del agregado `Shift`** siguiendo cada sección:

---

# ADR-20: Reubicación del agregado Shift en el submódulo Administración/Operativo
...
- Este ADR se relaciona directamente con ADR‑42 (manejo de múltiples violaciones de reglas de negocio).
