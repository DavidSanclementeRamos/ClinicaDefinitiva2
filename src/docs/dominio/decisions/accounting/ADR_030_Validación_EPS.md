# ADR-22 (Dominio): Estrategia de validación de EPS del paciente
...
- ADR-07 (Arquitectura): Separación de Facturación y Pagos en módulos independientes.
- ADR-08 (Arquitectura): Redefinición del módulo Administration.
- ADR-09 (Arquitectura): Estrategia de Integraciones.  
