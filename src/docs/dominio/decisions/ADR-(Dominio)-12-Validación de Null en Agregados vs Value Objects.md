...
- Este ADR complementa **ADR‑21 (Catálogos de errores por agregado con interfaz común)**:
    - ADR‑21 define que cada agregado tiene su catálogo.
    - ADR‑51 aclara que esos catálogos **no deben duplicar invariancias de VOs**.
