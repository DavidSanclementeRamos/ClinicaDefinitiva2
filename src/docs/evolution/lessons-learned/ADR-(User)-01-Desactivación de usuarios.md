...
- **Fecha**: 2025-11-12
- **Estado**:  Superado - Reemplazado por [ADR-(Arquitectura)-39](../../architecture/decisions/arch/ADR-%28Arquitectura%29-39-Ubicaci%C3%B3n%20de%20validaciones%20de%20desactivaci%C3%B3n.md) y [ADR-(Arquitectura)-38](../../architecture/decisions/arch/ADR-%28Arquitectura%29-38-UserDeactivationPolicy%20como%20orquestador%20de%20validaciones.md)
...
**Evolución:**
- ADR-39 (30/01/2026): Migró validación a `UserAccessValidator`
- ADR-38 (30/01/2026): Introdujo `UserDeactivationPolicy` como orquestador
...
**ADR-38:** `UserAccessValidator` valida acceso del usuario (verificado, no bloqueado, activo)

**ADR-38:** `UserDeactivationPolicy` orquesta validaciones cruzadas (citas pendientes, tratamientos activos, etc.)
...
## Código Correcto (Implementado en ADR-023 y ADR-38)
...
- **Reemplazado por:**
   - [ADR-(Arquitectura)-38-UserDeactivationPolicy como orquestador de validaciones.md](../../architecture/decisions/arch/ADR-%28Arquitectura%29-38-UserDeactivationPolicy%20como%20orquestador%20de%20validaciones.md)
   - [ADR-(Arquitectura)-39-Ubicación de validaciones de desactivación.md](../../architecture/decisions/arch/ADR-%28Arquitectura%29-39-Ubicaci%C3%B3n%20de%20validaciones%20de%20desactivaci%C3%B3n.md)
