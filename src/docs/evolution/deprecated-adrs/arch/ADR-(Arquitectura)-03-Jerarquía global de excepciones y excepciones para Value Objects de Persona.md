...
- Estado: Superado por ADR-18 (Simplificación general de jerarquía de excepciones)
- Fecha: 2025-10-02
- Autor: David Stiven Sanclemenente
...
- [ADR-(Arquitectura)-02-Catálogo de errores clínicos por operación.md](ADR-%28Arquitectura%29-02-Cat%C3%A1logo%20de%20errores%20cl%C3%ADnicos%20por%20operaci%C3%B3n.md)
- [ADR-(Arquitectura)-04-Jerarquía de excepciones para valores faltantes en Value Objects.md](ADR-%28Arquitectura%29-04-Jerarqu%C3%ADa%20de%20excepciones%20para%20valores%20faltantes%20en%20Value%20Objects.md)
