# ADR-12 (Arquitectura): Nuevos agregados en el módulo Administration
...
- [ADR-17 (Arquitectura): Manejo de Plan de Cuentas y Asientos Contables en el Sistema Clínico.](ADR-17-Manejo-de-plan-de-cuenta-y-asiento-contable.md)  
