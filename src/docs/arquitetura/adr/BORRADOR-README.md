...
Aunque el curso no cubría el desarrollo completo, decidí tomarlo como base para aplicar todo lo aprendido y construir un sistema odontológico real, trazable y ético.
...
# [Value-Objects](ADR-02-Value-Objects-(VO).md)