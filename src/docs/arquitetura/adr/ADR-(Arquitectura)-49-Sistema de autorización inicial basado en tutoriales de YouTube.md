...
- **Estado:** Retrospectivo (superado por ADR-14)
- **Fecha:** 2026-02-09
- **Autor:** David
...
Este ADR completa la narrativa: ahora se ent# ADR-49 (Arquitectura): Sistema de autorización inicial basado en tutoriales de YouTube
...
Este ADR completa liende **por qué** ADR-14 fue tan radical y necesario.