...
- **Complementa**: ADR-37 (Arquitectura hexagonal), ADR-46 (JWT)
...
**Complementa:**
- ADR-37: Arquitectura hexagonal (AuthorizationService es domain service)
- ADR-46: JWT (tokens incluyen roles para autorización)
- ADR-34: Outcome vs Exceptions (autorizaciones fallidas lanzan exception)

**Motiva:**
- ADR-39: Integración Spring Security (uso de AuthorizationService)
- ADR-40: Gestión de roles múltiples (UserRolAssignment)