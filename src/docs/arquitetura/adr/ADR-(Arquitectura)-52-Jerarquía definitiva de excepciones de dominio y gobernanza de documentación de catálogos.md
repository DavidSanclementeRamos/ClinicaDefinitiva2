...
**Fecha:** 2026-03-03  
**Autor:** David  
**Reemplaza parcialmente:** ADR-18-(Arquitectura), ADR-19-(Arquitectura), ADR-21-(Arquitectura), ADR-42-(Arquitectura)  
**Complementa:** ADR-22-(Arquitectura), ADR-23-(Arquitectura), ADR-30-(Arquitectura)
...
- ADR-19: Catálogo único con contextos diferenciados (VOContext / EntityContext)
- ADR-21: Catálogos por agregado con interfaz común
- ADR-22: Estrategia de numeración de catálogos
- ADR-23: Histórico de catálogos eliminados — Módulo Actor
- ADR-30: Histórico de catálogos eliminados — Módulo dental.care.services
- ADR-42: AggregateBusinessRuleViolationException