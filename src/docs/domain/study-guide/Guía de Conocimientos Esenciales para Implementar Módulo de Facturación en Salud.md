# Guía de Conocimientos Esenciales para Implementar Módulo de Facturación en Salud
...
- Ver **[billing-mvp-scope.md.md](../billing-mvp-scope.md.md)** para el alcance específico de implementación del MVP
